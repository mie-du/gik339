...
const headingElement = `<h1 class="p-5 bg-primary text-white">${applicationTitle}</h1>`;
document.body.insertAdjacentHTML('afterbegin', headingElement);

const todoListContainerElement = document.createElement('div');
todoListContainerElement.classList.add('container', 'mt-4');
const todoListElement = document.createElement('ul');
todoListElement.classList.add('list-group');
